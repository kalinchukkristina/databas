...
DROP INDEX IF EXISTS prod_name_idx ON produkt;
DROP INDEX IF EXISTS order_rad_idx  ON ordrar;
DROP INDEX IF EXISTS plocklista_order_rad_idx ON plocklista_rad;

CREATE INDEX prod_name_idx ON produkt (namn);
CREATE INDEX order_rad_idx ON ordrar (rader);
CREATE INDEX plocklista_order_rad_idx ON plocklista_rad(order_id);
